...
Setting('STOCK_BARCODE_LOOKUP_PLUGIN', 'OpenFoodAndBeautyFactsBarcodeLookupPlugin');
*/

class OpenFoodAndBeautyFactsBarcodeLookupPlugin extends BaseBarcodeLookupPlugin
{
