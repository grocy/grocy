...
/*
	...
	Setting('STOCK_BARCODE_LOOKUP_PLUGIN', 'OpenBeautyFactsBarcodeLookupPlugin');
*/

class OpenBeautyFactsBarcodeLookupPlugin extends BaseBarcodeLookupPlugin
{
	...
	protected function ExecuteLookup($barcode)
	{
		...
		$response = $webClient->request('GET', 'https://world.openbeautyfacts.org/api/v2/product/' . preg_replace('/[^0-9]/', '', $barcode) . '?fields=product_name,image_url,' . $productNameFieldLocalized, ['headers' => ['User-Agent' => 'GrocyOpenFoodFactsBarcodeLookupPlugin/1.0 (https://grocy.info)']]);
