	...
	public static function PopulateDemoData(PDO $pdo)
	{
		...
		if (intval($rowCount) === 0)
		{
			$sql = "
				...
				INSERT INTO locations (name) VALUES ('S��igkeitenschrank'); --2
				INSERT INTO locations (name) VALUES ('Konservenschrank'); --3
				INSERT INTO locations (name) VALUES ('K�hlschrank'); --4

				UPDATE quantity_units SET name = 'St�ck' WHERE id = 1;
				...
				INSERT INTO products (name, location_id, qu_id_purchase, qu_id_stock, qu_factor_purchase_to_stock, min_stock_amount) VALUES ('Gummib�rchen', 2, 2, 2, 1, 8); --3
