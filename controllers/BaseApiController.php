...
class BaseApiController extends BaseController
{
	...
	protected function ApiResponse(ResponseInterface $response, $data, $cache = false)
	{
		if ($cache)
		{
	...
	protected function EmptyApiResponse(ResponseInterface $response, $status = 204)
	{
		return $response->withStatus($status);
	}

	protected function GenericErrorResponse(ResponseInterface $response, $errorMessage, $status = 400)
	{
	...
	public function FilteredApiResponse(ResponseInterface $response, Result $data, array $query)
	{
