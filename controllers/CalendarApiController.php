...
{
	public function Ical(ServerRequestInterface $request, ResponseInterface $response, array $args)
	{
		try
		{
	...
	public function IcalSharingLink(ServerRequestInterface $request, ResponseInterface $response, array $args)
	{
		try
		{
