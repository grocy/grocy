...
class BatteriesController extends BaseController
{
	...
	public function BatteriesList(ServerRequestInterface $request, ResponseInterface $response, array $args)
	{
	...
	public function BatteriesSettings(ServerRequestInterface $request, ResponseInterface $response, array $args)
	{
		return $this->renderPage($response, 'batteriessettings');
	}

	public function BatteryEditForm(ServerRequestInterface $request, ResponseInterface $response, array $args)
	{
	...
	public function BatteryGrocycodeImage(ServerRequestInterface $request, ResponseInterface $response, array $args)
	{
