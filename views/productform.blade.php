...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6 col-12">
            ...
            <form id="product-form" class="has-sticky-form-footer" novalidate>
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
						...
						@elseif($mode == 'edit' && $product->active == 1) checked @endif
                            class="form-check-input custom-control-input" type="checkbox" id="active" name="active"
                            value="1">
                ...
                @include('components.productpicker', [
				    'productsQuery' => (isset($product) ? 'query%5B%5D=id!%3D' . rawurlencode($product->id) . '&' : '') . 'query%5B%5D=parent_product_id%3Dnull&query%5B%5D=active%3D1&order=name%3Acollate%20nocase',
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control wysiwyg-editor" id="description" name="description">
                        @if ($mode == 'edit')
    {{ $product->description }}
    @endif
                        </textarea>
                ...
                @if (GROCY_FEATURE_FLAG_STOCK_LOCATION_TRACKING)
                    <div class="form-group">
                        ...
                        <select required class="custom-control custom-select" id="location_id" name="location_id">
                            <option></option>
                            @foreach ($locations as $location)
                                <option @if ($mode == 'edit' && $location->id == $product->location_id) selected="selected" @endif
                ...
                @if (GROCY_FEATURE_FLAG_STOCK_PRICE_TRACKING)
                    @include('components.shoppinglocationpicker', [
                        'label' => 'Default store',
                        'prefillById' => $prefillById,
                ...
                <div class="form-group @if (GROCY_FEATURE_FLAG_STOCK_PRODUCT_OPENED_TRACKING) mb-1 @endif">
                    <div class="custom-control custom-checkbox">
                        <input @if ($mode == 'edit' && $product->cumulate_min_stock_amount_of_sub_products == 1) checked @endif
                            class="form-check-input custom-control-input" type="checkbox"
                            id="cumulate_min_stock_amount_of_sub_products" name="cumulate_min_stock_amount_of_sub_products"
                            value="1">
                ...
                @if (GROCY_FEATURE_FLAG_STOCK_PRODUCT_OPENED_TRACKING)
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input @if ($mode == 'edit' && $product->treat_opened_as_out_of_stock == 1) checked @endif
                                class="form-check-input custom-control-input" type="checkbox"
                                id="treat_opened_as_out_of_stock" name="treat_opened_as_out_of_stock" value="1">
                            <label class="form-check-label custom-control-label"
                                for="treat_opened_as_out_of_stock">{{ $__t('Treat opened as out of stock') }}&nbsp;<i
                                    class="fas fa-question-circle text-muted" data-toggle="tooltip"
                                    data-trigger="hover click"
                ...
                @if (GROCY_FEATURE_FLAG_STOCK_BEST_BEFORE_DATE_TRACKING)
                    <div class="form-group">
                        <label class="d-block my-0" for="location_id">{{ $__t('Due date type') }}
                        ...
                        <div class="custom-control custom-radio mt-n2">
                            <input class="custom-control-input" type="radio" name="due_type" id="due-type-bestbefore"
                                value="1" @if ($mode == 'edit' && $product->due_type == 1) checked @else checked @endif>
                            <label class="custom-control-label" for="due-type-bestbefore">{{ $__t('Best before date') }}
                                <i class="fas fa-question-circle text-muted" data-toggle="tooltip"
                                    data-trigger="hover click"
                        ...
                        <div class="custom-control custom-radio mt-n2">
                            <input class="custom-control-input" type="radio" name="due_type" id="due-type-expiration"
                                value="2" @if ($mode == 'edit' && $product->due_type == 2) checked @endif>
                            <label class="custom-control-label" for="due-type-expiration">{{ $__t('Expiration date') }}
                                <i class="fas fa-question-circle text-muted" data-toggle="tooltip"
                                    data-trigger="hover click"
                    ...
                    @else
                        <input type="hidden" name="default_best_before_days_after_open"
                            id="default_best_before_days_after_open" value="1">
                    @endif
                @else
                    <input type="hidden" name="default_best_before_days" id="default_best_before_days" value="1">
                    <input type="hidden" name="due_type" id="due_type" value="1">
                @endif
                ...
                @if (GROCY_FEATURE_FLAG_STOCK_PRODUCT_FREEZING)
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input @if ($mode == 'edit' && $product->should_not_be_frozen == 1) checked @endif
                                class="form-check-input custom-control-input" type="checkbox" id="should_not_be_frozen"
                                name="should_not_be_frozen" value="1">
                            <label class="form-check-label custom-control-label"
                                for="should_not_be_frozen">{{ $__t('Should not be frozen') }}&nbsp;<i
                                    class="fas fa-question-circle text-muted" data-toggle="tooltip"
                                    data-trigger="hover click"
                ...
                @else
                    ...
                    <input type="hidden" name="should_not_be_frozen" value="0">
                @endif

                <div class="form-group">
                    <label for="product_group_id">{{ $__t('Product group') }}</label>
                    {{-- TODO: Select2: dynamic data: product_groups --}}
                    <select class="custom-control custom-select" id="product_group_id" name="product_group_id">
                        <option></option>
                        @foreach ($productgroups as $productgroup)
                            <option @if ($mode == 'edit' && $productgroup->id == $product->product_group_id) selected="selected" @endif
                ...
                <div class="form-group">
                    ...
                    <select required class="custom-control custom-select input-group-qu" id="qu_id_stock" name="qu_id_stock"
                        @if ($mode == 'edit') disabled @endif>
                        <option></option>
                        @foreach ($quantityunits as $quantityunit)
                            <option @if ($mode == 'edit' && $quantityunit->id == $product->qu_id_stock) selected="selected" @endif
                ...
                <div class="form-group">
                    ...
                    {{-- TODO: Select2: dynamic data: quantity_units --}}
                    <select required class="custom-control custom-select input-group-qu" id="qu_id_purchase"
                        name="qu_id_purchase">
                        <option></option>
                        @foreach ($quantityunits as $quantityunit)
                            <option @if ($mode == 'edit' && $quantityunit->id == $product->qu_id_purchase) selected="selected" @endif
                ...
                <div class="form-group mb-1">
                    <div class="custom-control custom-checkbox">
                        <input @if ($mode == 'edit' && $product->enable_tare_weight_handling == 1) checked @endif
                ...
                @if (GROCY_FEATURE_FLAG_RECIPES)
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input @if ($mode == 'edit' && $product->not_check_stock_fulfillment_for_recipes == 1) checked @endif
                                class="form-check-input custom-control-input" type="checkbox"
                                id="not_check_stock_fulfillment_for_recipes" name="not_check_stock_fulfillment_for_recipes"
                                value="1">
                            <label class="form-check-label custom-control-label"
                ...
                @else
                    <input type="hidden" name="not_check_stock_fulfillment_for_recipes"
                        id="not_check_stock_fulfillment_for_recipes" value="0">
                @endif
                ...
                @if (GROCY_FEATURE_FLAG_LABEL_PRINTER)
                    <div class="form-group">
                        ...
                        <select class="form-control" id="default_stock_label_type" name="default_stock_label_type">
                            <option @if ($mode == 'edit' && intval($product->default_stock_label_type) == 0) selected="selected" @endif value="0">
                                {{ $__t('No label') }}</option>
                            <option @if ($mode == 'edit' && intval($product->default_stock_label_type) == 1) selected="selected" @endif value="1">
                                {{ $__t('Single label') }}</option>
                            <option @if ($mode == 'edit' && intval($product->default_stock_label_type) == 2) selected="selected" @endif value="2">
                                {{ $__t('Label per unit') }}</option>
                        </select>
                    </div>
                @endif
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input @if ($mode == 'edit' && $product->hide_on_stock_overview == 1) checked @endif
                            class="form-check-input custom-control-input" type="checkbox" id="hide_on_stock_overview"
                            name="hide_on_stock_overview" value="1">
                        <label class="form-check-label custom-control-label"
                            for="hide_on_stock_overview">{{ $__t('Never show on stock overview') }}&nbsp;<i
                ...
                <div class="sticky-form-footer pt-1">
                    ...
                    <button id="save-product-button" class="save-product-button btn btn-success mb-2 default-submit-button"
        ...
        <div class="col-lg-6 col-12">
            ...
            <div class="row @if ($mode == 'create' || !GROCY_FEATURE_FLAG_STOCK) d-none @endif">
                <div class="col">
                    ...
                    <table id="barcode-table" class="table table-sm table-striped nowrap w-100">
                        <thead>
                            <tr>
                                <th class="border-right"><a class="text-muted change-table-columns-visibility-button"
                                        data-toggle="tooltip" data-toggle="tooltip" title="{{ $__t('Table options') }}"
                                        data-table-selector="#barcode-table" href="#"><i class="fas fa-eye"></i></a>
                                </th>
                                <th>{{ $__t('Barcode') }}</th>
                                ...
                                <th>{{ $__t('Amount') }}</th>
                                <th class="@if (!GROCY_FEATURE_FLAG_STOCK_PRICE_TRACKING) d-none @endif">{{ $__t('Last price') }}
                                </th>
                                <th>{{ $__t('Note') }}</th>
                                        ...
                                        <tr>
                                            <td class="fit-content border-right">
                                                ...
                                                <a class="btn btn-sm btn-danger barcode-delete-button @if ($barcode->product_id == null) disabled @endif"
                                                    href="#" data-barcode-id="{{ $barcode->id }}"
                        ...
                        <p>
                            ...
                            @if (GROCY_FEATURE_FLAG_LABEL_PRINTER)
                                <a class="btn btn-outline-primary btn-sm product-grocycode-label-print"
                                    data-product-id="{{ $product->id }}" href="#">
            ...
            <div
                ...
                <div class="col">
                    ...
                    <table id="qu-conversions-table-products" class="table table-sm table-striped nowrap w-100">
                        <thead>
                            <tr>
                                <th class="border-right"><a class="text-muted change-table-columns-visibility-button"
                                        data-toggle="tooltip" title="{{ $__t('Table options') }}"
                                        data-table-selector="#qu-conversions-table-products" href="#"><i
                                        ...
                                        <tr>
                                            <td class="fit-content border-right">
                                                ...
                                                <a class="btn btn-sm btn-danger qu-conversion-delete-button @if ($quConversion->product_id == null) disabled @endif"
                                                    href="#" data-qu-conversion-id="{{ $quConversion->id }}">
                                                    <i class="fas fa-trash"></i>
                                                </a>
                                            </td>
                                            <td>
            ...
            <div class="row @if ($mode == 'edit') mt-5 @endif">
                <div class="col">
                    ...
                    @else
                        <p id="no-current-product-picture-hint" class="form-text text-muted font-italic mb-5">
